const QUESTIONS_DATABASE = [
  ...
  { id: 6, act: 2, path: 'community', storyText: null, character: 'bear', questionText: '你正在查看 Slack 頭像以記住名字。這是誰？', answers: ['選項 A','選項 B','選項 C','選項 D'], correctAnswer: 0, type: 'single-choice', special: 'slack-avatar' },
  { id: 7, act: 2, path: 'community', storyText: null, character: 'bear', questionText: '創辦人經營一個受歡迎的 FB 粉專。它叫什麼名字？', answers: ['選項 A','選項 B','選項 C','選項 D'], correctAnswer: 0, type: 'single-choice' },
  ...
  { id: 8, act: 3, path: 'both', storyText: '你準備好成為客戶了，但首先你需要證明你真的了解 MM...', character: 'bear', questionText: '快！"MM" 實際上代表什麼意思？', answers: ['MacroMicro','MicroMacro','ModernMacro','MarketMacro'], correctAnswer: 0, type: 'single-choice' },
